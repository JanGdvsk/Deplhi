...
// производим парсинг по справочнику
  StartStr := Start_Value_of_work;
  LastStartStr := Start_Value_of_work;  // последний удачный парсинг
  LastEndStr := Start_Value_of_work;  // последний удачный парсинг
  for i := Low_Value to Dictonary_Length do
  begin
